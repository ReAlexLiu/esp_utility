...
<body class="bg-gray-100">
...
#ifdef ENABLE_WIFI
    R"rawliteral(<div class="tab-button active px-6 py-4 text-gray-700" data-tab="wifi">WiFi配置</div>)rawliteral"
#endif
#ifdef ENABLE_DS18B20
    R"rawliteral(<div class="tab-button px-6 py-4 text-gray-700" data-tab="ds18b20">DS18B20配置</div>)rawliteral"
#endif
#ifdef ENABLE_FAN
...
#endif
#ifdef ENABLE_OTA
    R"rawliteral(<div class="tab-button px-6 py-4 text-gray-700" data-tab="ota">OTA更新</div>)rawliteral"
#endif
    R"rawliteral(
                </div>
            </div>
    ...
    R"rawliteral(
            ...
            <div id="wifi-content" class="tab-content active p-6">
                ...
                <form id="wifiForm" class="space-y-6">
                    <!-- 扫描按钮 -->
                    <div class="mb-4">
                        <button type="button" id="scanBtn" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition duration-200 flex items-center justify-center">
                    ...
                    <div class="overflow-x-auto mb-4">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tl-lg">WiFi名称 (SSID)</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">信号强度</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-lg">加密方式</th>
                                </tr>
                            </thead>
                    ...
                    <div id="networkConfig" class="space-y-4 hidden">
                        <div>
                            <label for="selectedSsid" class="block text-sm font-medium text-gray-700 mb-1">选中的网络</label>
                    ...
                    <div class="flex space-x-4 pt-2">
                        <button type="submit" id="connectBtn" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition duration-200 flex items-center justify-center" disabled>
                            <i class="fa fa-wifi mr-2"></i> 连接网络
                        </button>
                        <button type="button" id="resetBtn" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-md transition duration-200 flex items-center">
                ...
                <div id="connect-progress" class="mt-4 hidden">
                    <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div id="connect-progress-bar" class="h-full bg-green-500 rounded-full progress-bar" style="width: 0%"></div>
                    </div>
            ...
            <div id="ds18b20-content" class="tab-content p-6">
                ...
                <div class="flash-card bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 mb-6 transition-all duration-200">
                    ...
                    <p class="text-sm text-gray-600">
                        ...
                        <span class="inline-flex items-center ml-2"><span class="status-indicator status-disconnected"></span>未连接</span>
                    </p>
                </div>
                ...
                <form id="configForm" class="space-y-6">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tl-lg">传感器</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">设备地址</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">当前温度</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">连接状态</th>
                                    <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-lg">输出引脚</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="sensor-row">
                                    ...
                                    <td class="px-4 py-4">
                                        <div id="address-1" class="text-sm text-gray-600 font-mono break-all max-w-[120px]">--</div>
                                    </td>
                                    <td class="px-4 py-4">
                                    ...
                                    <td class="px-4 py-4">
                                        <select name="output-1" class="form-select block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                ...
                                <tr class="sensor-row">
                                    ...
                                    <td class="px-4 py-4">
                                        <div id="address-2" class="text-sm text-gray-600 font-mono break-all max-w-[120px]">--</div>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm text-gray-900">
                                            <span id="temp-2">--.-</span>
                                    ...
                                    <td class="px-4 py-4">
                                        <select name="output-2" class="form-select block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                            <option value="5">GPIO5</option>
                                            <option value="13">GPIO13</option>
                                            <option value="12">GPIO12</option>
                                            <option value="14">GPIO14</option>
                                ...
                                <tr class="sensor-row">
                                    ...
                                    <td class="px-4 py-4">
                                        <div id="address-3" class="text-sm text-gray-600 font-mono break-all max-w-[120px]">--</div>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm text-gray-900">
                                            <span id="temp-3">--.-</span>
                                    ...
                                    <td class="px-4 py-4">
                                        <select name="output-3" class="form-select block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                            <option value="5">GPIO5</option>
                                            <option value="13">GPIO13</option>
                                            <option value="12">GPIO12</option>
                                            <option value="14">GPIO14</option>
                                ...
                                <tr class="sensor-row">
                                    ...
                                    <td class="px-4 py-4">
                                        <div id="address-4" class="text-sm text-gray-600 font-mono break-all max-w-[120px]">--</div>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm text-gray-900">
                                            <span id="temp-4">--.-</span>
                                    ...
                                    <td class="px-4 py-4 rounded-br-lg">
                                        <select name="output-4" class="form-select block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                            <option value="5">GPIO5</option>
                                            <option value="13">GPIO13</option>
                                            <option value="12">GPIO12</option>
                                            <option value="14">GPIO14</option>
                    ...
                    <div class="flex space-x-4 pt-2">
                        ...
                        <button type="button" id="refreshBtn" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-md transition duration-200 flex items-center">
    ...
    R"rawliteral(
            ...
            <div id="fan-content" class="tab-content p-6">
                ...
                <div class="control-card bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 mb-8 transition-all duration-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="relative inline-block w-12 h-6">
                            <input type="checkbox" id="control-toggle" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"/>
                            <label for="control-toggle" class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="control-card bg-white border border-gray-200 rounded-lg p-4 transition-all duration-200">
                        ...
                        <input type="range" id="fan1-slider" min="0" max="100" value="0"
                               class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-500" disabled>
                        <div class="mt-2 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div id="fan1-progress" class="progress-bar h-full bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="control-card bg-white border border-gray-200 rounded-lg p-4 transition-all duration-200">
                        ...
                        <input type="range" id="fan2-slider" min="0" max="100" value="0"
                               class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-500" disabled>
                        <div class="mt-2 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div id="fan2-progress" class="progress-bar h-full bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="control-card bg-white border border-gray-200 rounded-lg p-4 transition-all duration-200">
                        ...
                        <input type="range" id="fan3-slider" min="0" max="100" value="0"
                               class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-500" disabled>
                        <div class="mt-2 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div id="fan3-progress" class="progress-bar h-full bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="control-card bg-white border border-gray-200 rounded-lg p-4 transition-all duration-200">
                        ...
                        <input type="range" id="fan4-slider" min="0" max="100" value="0"
                               class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-500" disabled>
                        <div class="mt-2 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div id="fan4-progress" class="progress-bar h-full bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 批量控制按钮 -->
                <div class="mt-6">
                    <button id="apply-all" class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                        应用所有设置
                    </button>
                </div>
    ...
    R"rawliteral(
            ...
            <div id="ota-content" class="tab-content p-6">
                ...
                <div class="flash-card bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 mb-6 transition-all duration-200">
                    ...
                    <div class="mt-3">
                        <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div id="storage-progress" class="h-full bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
                ...
                <form id="uploadForm" class="space-y-4">
                    <div>
                        ...
                        <input type="file" id="firmware" accept=".bin" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                    </div>
                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition duration-200">上传并更新</button>
                </form>
